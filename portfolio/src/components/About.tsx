...
// import { Code, Palette, MapPin, Trophy, GraduationCap, FolderCode, ChevronDown } from "lucide-react";
...
//             {/* What I Do */}
//             <div className="border border-gray-200 rounded-2xl bg-white shadow-sm overflow-hidden select-none">
//               <button
